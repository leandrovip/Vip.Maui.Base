...
namespace Vip.Maui.Base.Objects
{
    /// <summary>
    ...
    public class ObservableRangeCollection<T> : ObservableCollection<T>
    {
        ...
        {
            RaiseChangeNotificationEvents(NotifyCollectionChangedAction.Replace);
        }
        ...
        private void RaiseChangeNotificationEvents(NotifyCollectionChangedAction action, List<T>? changedItems = null, int startingIndex = -1)
        {
            ...
            OnCollectionChanged(changedItems is null ? new NotifyCollectionChangedEventArgs(action) : new NotifyCollectionChangedEventArgs(action, changedItems, startingIndex));
        }
    }
}